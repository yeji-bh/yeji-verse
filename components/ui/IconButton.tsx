    ...
    <button
      ...
      className={`inline-flex h-9 w-9 items-center justify-center rounded-xl border transition-colors ${
        active
          ...
          : "border-[var(--color-border)] bg-[var(--color-bgMuted)] text-[var(--color-textMuted)] hover:text-[var(--color-text)] hover:border-[var(--color-accent)]"
      } ${className}`}
    >
      {children}
    </button>
...
export function IconHeart({ filled = false, className = "h-4 w-4" }: { filled?: boolean; className?: string }) {
  return (
...
export function IconFilter({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function IconEye({ className = "h-3.5 w-3.5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
